class RanksController < ApplicationController
  ...
  private
    ...
    def rank_params
      params.require(:rank).permit(:name, :boy_id, :is_current, :service, :heritage, :hobbies, :life_skills, :outdoor_activities, :pioneer_skills, :sci_tech, :values, :start, :finish, :awarded)
    end
end
